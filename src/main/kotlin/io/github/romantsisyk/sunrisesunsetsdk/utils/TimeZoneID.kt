package io.github.romantsisyk.sunrisesunsetsdk.utils

enum class TimeZoneID(val id: String) {
    // Africa
    ...
    companion object {
        /**
         * Finds a TimeZoneID by its string ID.
         * Returns null if not found.
         */
        fun fromId(id: String): TimeZoneID? = entries.find { it.id == id }
    }
}
